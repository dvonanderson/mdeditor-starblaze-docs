...
Welcome to mdEditor Starblaze documentation!

## What is mdEditor Starblaze?

mdEditor Starblaze is a modern web application for writing metadata. Built using [Ember.js](http://emberjs.com/), it provides a powerful, user-friendly interface for creating and managing metadata with support for various standards and formats.
